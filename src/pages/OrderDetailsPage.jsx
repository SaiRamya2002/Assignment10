  ...
  return (
    <>
      {isLoading ? (
        ...
        <Message variant="danger" style={{ backgroundColor: "#F1F0E8", color: "#E5E1DA" }}>
          {error?.data?.message || error.error}
        </Message>
      ) : (
        <>
          <Meta title={"Order Details"} />
          <h1 style={{ color: "#89A8B2" }}>Order ID: {orderId}</h1>
          <Row>
            <Col md={8}>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  ...
                  {order?.isDelivered ? (
                    <Message variant="success" style={{ backgroundColor: "#B3C8CF" }}>
                      Delivered on{" "}
                      {new Date(order?.deliveredAt).toLocaleString()}
                    </Message>
                  ) : (
                    <Message variant={"danger"} style={{ backgroundColor: "#F1F0E8" }}>
                      {"Not Delivered"}
                    </Message>
                  )}
                </ListGroup.Item>
